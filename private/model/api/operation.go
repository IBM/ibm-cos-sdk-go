...
func (o *Operation) GetSigner() string {
	if o.AuthType == "v4-unsigned-body" {
		o.API.imports["github.com/IBM/ibm-cos-sdk-go/aws/signer/v4"] = true
	}
...
func (o *Operation) GoCode() string {
	...
	if len(o.OutputRef.Shape.EventStreamsMemberName) != 0 {
		o.API.imports["github.com/IBM/ibm-cos-sdk-go/aws/client"] = true
		o.API.imports["github.com/IBM/ibm-cos-sdk-go/private/protocol"] = true
		o.API.imports["github.com/IBM/ibm-cos-sdk-go/private/protocol/rest"] = true
		o.API.imports["github.com/IBM/ibm-cos-sdk-go/private/protocol/"+o.API.ProtocolPackage()] = true
	}

	if o.API.EndpointDiscoveryOp != nil {
		o.API.imports["github.com/IBM/ibm-cos-sdk-go/aws/crr"] = true
...
func (o *Operation) ExampleInput() string {
	if len(o.InputRef.Shape.MemberRefs) == 0 {
		if strings.Contains(o.InputRef.GoTypeElem(), ".") {
			o.imports["github.com/IBM/ibm-cos-sdk-go/service/"+strings.Split(o.InputRef.GoTypeElem(), ".")[0]] = true
